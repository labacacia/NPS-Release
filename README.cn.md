...
[![Release](https://img.shields.io/badge/release-v1.0.0--alpha.15-orange.svg)](CHANGELOG.cn.md#100-alpha15--2026-06-28)
...
> **版本：** 1.0.0-alpha.15 | **最新已发布版本：** 1.0.0-alpha.15 | **状态：** Released | **许可证：** Apache 2.0
>
...
alpha.15 release 文档跟踪 Banyan 集成反馈与 SDK 对齐工作：
