...
最新 suite release 是 `1.0.0-alpha.16`。当前文档与 SDK 说明已经对齐
alpha.16 release 边界；各生态包管理器可用性单独跟踪。
...
| Rust       | `cargo add nps-sdk@=1.0.0-alpha.16`                       | [SDK-Rust](https://github.com/labacacia/NPS-Release/wiki/SDK-Rust) |
| Go         | `go get github.com/labacacia/NPS-sdk-go@v1.0.0-alpha.16`  | [SDK-Go](https://github.com/labacacia/NPS-Release/wiki/SDK-Go) |
| Java       | `implementation("com.labacacia.nps:nps-java:1.0.0-alpha.16")` | [SDK-Java](https://github.com/labacacia/NPS-Release/wiki/SDK-Java) |
| .NET       | `dotnet add package LabAcacia.NPS.Core --version 1.0.0-alpha.16` | [SDK-dotnet](https://github.com/labacacia/NPS-Release/wiki/SDK-dotnet) |
