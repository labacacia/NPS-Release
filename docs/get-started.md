...
The latest suite release is `1.0.0-alpha.17`. The documentation and SDK notes
are aligned with the alpha.17 release boundary; package-manager availability is
