...
NPS 的路径分为四个 Phase — 从草案规范走向正式标准。当前发布 — **v1.0.0-alpha.7** — 完成 Phase 1 并在 Phase 2 取得重大进展。alpha.7 新增内容：`ReputationLogClient`（RFC-0004 Phase 2）已落地六种 SDK；Python / Go / Java / Rust 四种 SDK 的 AnchorNodeClient 测试覆盖对齐；NIP CA Server CR-0005 RA 模型数据库迁移。
...
- ✅ MCP、A2A、gRPC ingress 适配器已在 NuGet 发布 v1.0.0-alpha.7
