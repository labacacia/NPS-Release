...
- ✅ `services/NPS-AaaS-Profile.md` v0.1（Gateway Node、Vector Proxy Layer、L1/L2/L3 合规要求）
...
完整登记册：[NPS-Roadmap.md](https://github.com/labacacia/NPS-Release/blob/main/spec/NPS-Roadmap.md)。
