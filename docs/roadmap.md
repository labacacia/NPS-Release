...
- ✅ MCP, A2A, and gRPC ingress adapters packaged and published to Nexus at v1.0.0-alpha.16
...
- ✅ Native-mode NWP serving helpers and TC-N1/TC-N2 conformance helpers delivered for SDK alpha.16
