...
| `cert_chain` | array of string | required when `cert_format = "x509-der"` | DER-encoded certificate chain, base64url-encoded, leaf first. Excluded from the signed canonical JSON (see §5.1.3 canonicalisation note). |
