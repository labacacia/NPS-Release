...
- [x] **OQ-2 — IANA Private Enterprise Number (PEN)**: **Resolved
  2026-05-08** — IANA assigned PEN **65715** to LabAcacia / Neuro
  Protocol Suites Committee, wired in via NPS-CR-0004. The prior
  provisional arc `1.3.6.1.4.1.99999` is retired. All `NpsX509Oids`
