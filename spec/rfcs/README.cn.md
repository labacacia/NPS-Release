...
| 编号 | 标题 | 状态 | 接受日期 | 取代 |
|------|------|------|----------|------|
| [0001](./NPS-RFC-0001-ncp-connection-preamble.cn.md) | 为 NCP 原生模式加入连接前导，用于流量识别 | Active | 2026-04-25 | _—_ |
| [0002](./NPS-RFC-0002-x509-acme-nid-certs.cn.md) | NID 证书改用 X.509 + ACME | Active | 2026-05-17 | _—_ |
| [0003](./NPS-RFC-0003-agent-identity-assurance-levels.cn.md) | Agent 身份三级保证等级（反爬 / 信任分流） | Active | 2026-04-25 | _—_ |
