...
| [0006](./NPS-RFC-0006-ncp-native-transport.md) | NCP native mode transport binding — TCP framing, QUIC stream mapping, rekeying, `max_concurrent_streams` | Draft | _—_ | _—_ |
