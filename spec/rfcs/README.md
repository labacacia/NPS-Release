...
| [0002](./NPS-RFC-0002-x509-acme-nid-certs.md) | Adopt X.509 + ACME for NID certificates | Accepted | _—_ | _—_ |
...
| [0006](./NPS-RFC-0006-ncp-native-transport.md) | NCP native mode transport binding — TCP framing, QUIC stream mapping, rekeying, `max_concurrent_streams` | Accepted | _—_ | _—_ |
